...
const Header = () => {
  return (
    <div className='relative w-full text-center mx-auto min-h-screen flex flex-col items-center justify-center gap-4 px-[8%] py-20 '>
    ...
    {/* Left: Profile Image */}
    <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-12 lg:gap-20 mx-auto">
    <div className="flex-shrink-0 w-44 sm:w-64 md:w-80 lg:w-96 mx-auto md:mx-0">
      ...
      <div className="flex-1 flex flex-col text-center md:text-left gap-6 max-w-2xl">
      ...
      <div className='flex flex-col sm:flex-row justify-center md:justify-start gap-4 mt-6'>
        <a href="#contact" className='px-10 py-3 bg-gradient-to-r from-[#8B5CF6] to-[#06B6D4] hover:from-[#06B6D4] hover:to-[#8B5CF6] rounded-full text-white font-medium shadow-md flex items-center gap-2 transition-all duration-300'>Contact
